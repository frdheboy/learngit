...
/**请求基础*/
var config_base_url = {
    base_jhss_url: "http://" + config_address.data_address + "/jhss/",
...
var config_url = {
    ...
    /*股市学堂频道**/
    schoolmoudules: config_base_url.user_url + 'wap/app/classroom/articleAction/querySchoolModules?moduleIds={moduleIds}',
    /*股市学堂地址**/
    modulearticlelist: config_base_url.user_url + "wap/app/classroom/articleAction/newModuleStaticArticleList?moduleId={moduleId}",
    /*股市学堂文章地址**/
    getarticle: config_base_url.user_url + "wap/app/classroom/articleAction/getArticle?id={id}",
    /*股票列表**/
    ...
    /*用户账户信息*/
    showuseracountinfo: config_base_url.base_url + "simtrade/showuseracountinfo/{ak}/{userid}/{queryuid}/{querymid}",
    /*牛人播报*/
    ...
    /*个股报价（大盘详细）*/
    curprice: config_base_url.user_url + "quote/stocklist/board/stock/curprice?code={code}",
    /*大盘指数右侧详细信息*/
    querycurstatusesbyte: config_base_url.base_url + "quote/querycurstatuses/{ak}/{sid}/{codes}",
    /*忧顾资讯列表内容接口*/
    /*自选股查询接口*/
    queryportfolio: config_base_url.base_jhss_url + 'portfolio/query/{userid}?v={version}',
    /*自选股修改接口*/
    modifyportfolio: config_base_url.base_jhss_url + 'portfolio/modify',
    /*消息中心接口*/
    noticecenter: config_base_url.user_url + "youguu/assist/notice/list?fromid={fromid}&reqnum={reqnum}",
    /*我的关注列表*/
    myattentionlist: config_base_url.base_jhss_url + 'member/queryFollows/{ak}/{sid}/{uid}/{startnum}/{limit}',
    /*我的粉丝列表*/
    myfanslist: config_base_url.base_jhss_url + 'member/queryFans/{ak}/{sid}/{uid}/{start}/{end}',
    /*添加关注*/
    addmyattention: config_base_url.base_jhss_url + 'member/addFollow/{ak}/{sessionid}/{uid}/{followId}',
    /*取消关注*/
    removemyattention: config_base_url.base_jhss_url + 'member/cancelFollow/{ak}/{sessionid}/{uid}/{followId}',
    /*个人盈利曲线*/
    profitline: config_base_url.base_url + "simtrade/profitline?userid={userid}&matchid={matchid}&date={date}&reqnum={reqnum}&pflag={pflag}",
    /*我的任务*/
    mytasklist: config_base_url.base_jhss_url + "task/myTaskList",
    /*领取金币接口*/
    getgold: config_base_url.base_jhss_url + "task/getGold?taskId={taskId}",
    /*做任务接口*/
    dotask: config_base_url.base_jhss_url + "task/doTask?taskId={taskId}"
...
GalHttpRequest.prototype.requestFromNet = function (callback) {
    ...
    var url = replaceUrl(this.base_url, this.params);
    $.ajax({
        dataType: 'text',
        type: "GET",
        crossDomain: true,
...
GalHttpRequest.prototype.postDataToNet = function (data, callback) {
    var url = replaceUrl(this.base_url, this.params);
    $.ajax({
        type: "POST",
        url: url,
