...
$(document).ready(function () {
    ...
    function buju(opt) {
        ...
        var gal = new GalHttpRequest(config_url.recommen_rank, opts);
        gal.requestFromNet({
                ...
                $(".superman_big>div").click(function () {
                    ...
                    if (biaoshifu1) {
                        ...
                        $(this).siblings("div").find("ul:last").slideUp(300);
							$(this).find("a.infobtn").click(function (e) {
							   window.location.href = "http://www.youguu.com/download/mncg_code.html";
